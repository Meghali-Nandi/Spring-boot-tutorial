...
- Declare methods in openfeign - 
	...
	Enable feignclient by annotation ApplicationClass with @EnableFeignClients
...
Resilience4j has different modules. Following are 2 imp out of them -
CircuitBreaker
Retry
...
CircuitBreaker has greater aspect order(preference) than Retry by default. 

Note- Configuration of these resilience4J modules can also be done using Java code though that gives us flexibility and power, it is very length, complex and error prone task.
